...
select /*+ index(c 3C15332B3C20431528_i19) */
 ...
 where 
       c.enfr_dt between to_date('20210701','yyyymmdd') and to_date('20210831','yyyymmdd')+0.99999
   and c.ordr_cd in ('BS4100','BS4141','BS4416GSM','BS4417','BS4152','BS4148','BS4480','BS4480GSM','BS4490GSM')
