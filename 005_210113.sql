...
select /*+ index(c 3C15332B3C20431528_i19) */
       to_char(c.enfr_dt,'yyyy-mm') "MONTH"
       , c.hslc_dvsn_cd
       , c.ordr_cd
       , e.ordr_nm
       , count(c.ptno) cnt
 ...
 where 
       c.enfr_dt between to_date('20201201','yyyymmdd') and to_date('20201231','yyyymmdd')+0.99999
   and c.ordr_cd in ('BS4100','BS4141','BS4152','BS4417','BS4416GSM','BS4148')
